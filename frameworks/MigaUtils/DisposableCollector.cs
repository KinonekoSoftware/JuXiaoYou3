...
namespace Acorisoft.FutureGL.MigaUtils
{
    ...
    {
        public static T DisposeWith<T>(this T instance, DisposableCollector collector) where T : class, IDisposable
        {
    ...
    public class DisposableCollector : ICollection<IDisposable>, ICancelable, IDisposableCollector
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DisposableCollector"/> class with no disposables contained by it initially.
        /// </summary>
        public DisposableCollector()
        {
            _disposables = new List<IDisposable>();
        }
    
        /// <summary>
        /// Initializes a new instance of the <see cref="DisposableCollector"/> class with the specified number of disposables.
        /// </summary>
        /// <param name="capacity">The number of disposables that the new DisposableCollector can initially store.</param>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="capacity"/> is less than zero.</exception>
        public DisposableCollector(int capacity)
        {
            if (capacity < 0)
            {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DisposableCollector"/> class from a group of disposables.
        /// </summary>
        ...
        /// <summary>
        /// Gets the number of disposables contained in the <see cref="DisposableCollector"/>.
        /// </summary>
        public int Count => Volatile.Read(ref _count);
    
        /// <summary>
        /// Adds a disposable to the <see cref="DisposableCollector"/> or disposes the disposable if the <see cref="DisposableCollector"/> is disposed.
        /// </summary>
        ...
        public void Collect(IDisposable item) => Add(item);
    
        /// <summary>
        /// Removes and disposes the first occurrence of a disposable from the <see cref="DisposableCollector"/>.
        /// </summary>
        ...
        /// <summary>
        /// Removes and disposes all disposables from the <see cref="DisposableCollector"/>, but does not dispose the <see cref="DisposableCollector"/>.
        /// </summary>
        public void Clear()
        {
        ...
        /// <summary>
        /// Determines whether the <see cref="DisposableCollector"/> contains a specific disposable.
        /// </summary>
        ...
        /// <summary>
        /// Copies the disposables contained in the <see cref="DisposableCollector"/> to an array, starting at a particular array index.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the <see cref="DisposableCollector"/>.
        /// </summary>
