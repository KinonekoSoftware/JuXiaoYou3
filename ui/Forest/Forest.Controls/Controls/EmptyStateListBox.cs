...
namespace Acorisoft.FutureGL.Forest.Controls
{
    public class EmptyStateListBox : ForestListBoxBase
    {
        ...
        static EmptyStateListBox()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(EmptyStateListBox), new FrameworkPropertyMetadata(typeof(EmptyStateListBox)));
            IsEmptyProperty = DependencyProperty.Register(
                nameof(IsEmpty),
                typeof(bool),
                typeof(EmptyStateListBox),
