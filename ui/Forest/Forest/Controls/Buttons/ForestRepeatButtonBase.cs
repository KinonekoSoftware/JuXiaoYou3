...
{
    public abstract partial class ForestRepeatButtonBase : RepeatButton, IForestControl
    {
        protected ForestRepeatButtonBase()
        {
    ...
    public abstract partial class ForestIconRepeatButtonBase : ForestRepeatButtonBase, IForestIconControl
    {
