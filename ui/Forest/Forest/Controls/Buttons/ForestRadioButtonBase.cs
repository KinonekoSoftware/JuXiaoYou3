...
{
    public abstract partial class ForestRadioButtonBase : RadioButton, IForestControl
    {
        protected ForestRadioButtonBase()
        {
    ...
    public abstract partial class ForestIconRadioButtonBase : ForestRadioButtonBase, IForestIconControl
    {
    }
}