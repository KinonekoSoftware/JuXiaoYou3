...
{
    public abstract partial class ForestToggleButtonBase: ToggleButton, IForestControl
    {
    ...
    public abstract partial class ForestIconToggleButtonBase : ForestRepeatButtonBase, IForestIconControl
    {
