...
namespace Acorisoft.Miga.Doc.Parts
{
    ...
    public abstract class InputProperty2 : ObservableObject, ICloneable
    {
        ...
        protected abstract InputProperty2 CreateInstanceOverride();

        /// <summary>
        /// 复制当前的数据
        /// </summary>
        /// <param name="target">要复制到的目标实例。</param>
        protected virtual void ShadowCopy(InputProperty2 target)
        {
        ...
        public static XElement GetElement(InputProperty2 property)
        {
